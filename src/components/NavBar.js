...
function NavBar() {
  ...
  return (
    <div className='fixed w-full h-[80px] flex justify-between items-center px-4 bg-[#5c715e] text-gray-300'>
      ...
      {/* Hamburger */}
        ...
        {/* Mobile menu */}
          <ul className={!nav ? 'hidden' : 'absolute top-0 left-0 w-full h-screen bg-[#5c715e] flex flex-col justify-center items-center'}>
